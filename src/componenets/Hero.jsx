...
function Hero() {
  ...
  return (
    <div className='heroCon border-b border-secondary'>
      <div className='flex flex-col gap-6 py-10 sm:py-11.75 mx-6 sm:mx-10'>
        ...
        <button className='bg-secondary border border-primary w-fit text-white text-xs sm:text-sm font-bold nunito px-2.5 sm:px-3 py-2.25 rounded-[3px] hover:translate-x-0.5 transition-transform cursor-pointer' onClick={() => navigate("/shop")}>Explore Now</button>
      </div>
    </div>
  )
}
