  ...
  return (
    <div className='heroCon'>
      <div className='flex flex-col gap-6 py-10 sm:py-11.75 mx-6 sm:mx-10'>
        ...
        <button className='bg-choco border border-light w-fit text-xs sm:text-sm text-light font-bold nunito px-2.5 sm:px-3 py-2.25 rounded' onClick={() => navigate("/shop")}>Explore Now</button>
      </div>
    </div>
  )
}
