    ...
    <div style={styles} className='heroCon flex h-full bg-cover border-b bg-center bg-no-repeat border-secondary/50'>
      <div className="flex my-10 sm:mt-20 sm:mb-30 md:mt-20 md:mb-40 lg:mt-20 lg:mb-50 xl:mt-20 xl:mb-60 bg-white/12 backdrop-blur-[2px] border border-s-transparent border-white/50 h-fit rounded-br-4xl rounded-tr-4xl">
        <div className='flex flex-col gap-6 py-10 sm:py-12 mx-4 sm:mx-10'>
          <h1 className='text-4xl text-white sm:text-5xl md:text-6xl lg:text-7xl xl:text-[82px] font-medium tracking-tight -translate-x-1 sm:-translate-x-1 md:-translate-x-1.5'>Everything to <br /> <span>enhance your setup.</span> </h1>
