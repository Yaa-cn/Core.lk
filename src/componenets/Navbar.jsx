      ...
      <nav className='flex gap-10 sm:gap-0 sticky top-0 left-0 right-0 justify-between nunito w-full py-3.5 px-4 sm:px-10 z-100 bg-light border-secondary border-b'>
        ...
        <div className='flex sm:gap-[13.5%] md:gap-[45%]'>
          ...
          <ul className='hidden sm:flex no-underline text-sm font-medium'>
            ...
            <li className='flex items-center border-x border-secondary/30 px-5' ><NavLink className='activeLine' to='/about'>About</NavLink></li>
        ...
        <ul className='flex gap-5 sm:gap-6 no-underline'>
          <li className='my-auto '><NavLink className='iconColor' to='/wishlist'><RiHeartLine size={18} /></NavLink></li>
          <li className='my-auto relative'><NavLink className='iconColor' to='/cart'><RiShoppingCart2Line size={18} /><span className={`absolute justify-center items-center rounded-full w-4 h-4 text-[10px] text-white font-medium -right-3.25 -top-2.25 sm:-top-2.5 ${cart.length === 0 ? 'hidden' : 'flex'} ${location.pathname.includes('/cart') ? 'bg-black' : 'bg-primary'}`}>{cart.length}</span></NavLink></li>
          <li className='my-auto '><NavLink className='iconColor' to='/profile'><RiUserLine size={18} /></NavLink></li>
