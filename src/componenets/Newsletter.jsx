    ...
    return (
        <div className="relative flex text-center flex-col gap-5 my-8 px-8 py-6 md:p-10 lg:p-12 w-full" >
            ...
            <div className="flex justify-center">
                <input type="email" className="w-4/5 sm:w-3/4 md:w-2/3 lg:w-1/2 py-3 px-4 border border-secondary text-xs rounded-s-[3px] focus:border-primary focus:outline-none nunito" placeholder="Enter your email" />
