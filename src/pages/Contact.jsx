  ...
  return (
    <>
      <div className="flex flex-col lg:flex-row gap-10 my-10 mx-6 sm:mx-20 md:mx-30 xl:mx-40">
        ...
        {/* Form Section */}
        <div className="flex flex-col gap-2 py-8 px-8 sm:px-12 sm:py-10 bg-white rounded-sm border border-sec w-full">
          <div className="flex flex-col gap-3">
            <TitleBar firstText={'Get'} secText={'Support'} className={'text-2xl font-bold'} color={'text-sec'} />
        ...
        <div className="flex flex-col gap-10 lg:justify-between w-full">
          <div className="relative flex bg-white border border-sec rounded overflow-hidden">
            <RiPhoneFill size={60} className="text-sec mt-8 mr-1 ml-4" />
            <div className="flex flex-col mt-4 mb-12 ml-5">
              <TitleBar firstText={'Call'} secText={'Us'} className={'text-xl font-extrabold mb-0.5'} color={'text-sec'} />
          ...
          <div className="relative flex bg-white border border-sec rounded overflow-hidden">
            <RiBallPenFill size={60} className="text-sec mt-8 mr-1 ml-4" />
            <div className="flex flex-col mt-4 mb-12 ml-5">
              <TitleBar firstText={'Write to'} secText={'Us'} className={'text-xl font-extrabold mb-0.5'} color={'text-sec'} />
          ...
          <div className="relative flex bg-white border border-sec rounded overflow-hidden">
            <RiMapPinFill size={60} className="text-sec mt-8 mr-1 ml-4" />
            <div className="flex flex-col mt-4 mb-12 ml-5">
              <TitleBar firstText={'Visit'} secText={'Us'} className={'text-xl font-extrabold mb-0.5'} color={'text-sec'} />
