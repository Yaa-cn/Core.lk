          ...
          <form className="flex flex-col gap-7 text-xs">
            <div className="flex flex-col gap-5 mt-6">
              <input type="text" placeholder="Full Name"
                className="px-4 py-2.5 bg-white rounded-[3px] w-full border border-secondary focus:border-primary outline-0 placeholder:tracking-wide" />
              ...
              <textarea placeholder="Write Message" rows="5"
                className="px-4 pt-2.5 bg-white rounded-[3px] w-full border border-secondary focus:border-primary outline-0 placeholder:tracking-wide"></textarea>
            </div>
            <button type="button" className="w-full px-4 py-2.5 border-[1.5px] border-secondary rounded-[3px] bg-accent hover:bg-secondary hover:text-white transition-colors cursor-pointer">
              Send message
            </button>
          </form>
        </div>
